...
class _LoginRegisterState extends State<LoginRegister> {
  ...
  register() {
    ...
    if (_form.validate()) {
      ...
      map.putIfAbsent("realname", () => _realname.text.trim());
      map.putIfAbsent("phone", () => _phone.text.trim());
      map.putIfAbsent("code", () => _code.text.trim());
      map.putIfAbsent("password", () => _password.text.trim());
      map.putIfAbsent("qrpassword", () => _qrpassword.text.trim());
      print(map.toString());
      UserServer().getRegister(map, (success) async {
        ToastUtil.showToast('注册成功');
        await Future.delayed(Duration(seconds: 1), () {
          NavigatorUtils.perfectInformationPage(context, success['id'].toString());
        });
    ...
    return Container(
      child: Scaffold(
        appBar: new AppBar(
          ...
          title: Text('用户注册', style: TextStyle(fontSize: ScreenUtil().setSp(33))),
        ),
        body: Form(
            key: _formKey,
            child: Container(
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                                ...
                                child: TextFormField(
                                  ...
                                  autofocus: false,
                                  validator: (val) {
                                    RegExp regMobile = new RegExp('^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}\$');
                                    return val == '' ? "请输入手机号码" : !regMobile.hasMatch(val) ? "手机号码格式不对" : null;
                                  },
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                                ...
                                child: TextFormField(
                                  ...
                                  obscureText: true,
                                  validator: (val) {
                                    return val == '' ? '请输入确认密码' : val != _password.text ? '密码不一致' : null;
                                  },
